...
module Vipergen
  class ViperThor < Thor
	...
	option :template, :required => false, :default => 'medusa', :type => :string , :desc => "Template for the generation"
	...
	option :company, :required => false, :default => 'iFood', :type => :string, :desc => "Company to be specified on the file's header. Otherwise Company will be used"
	def generate(name)
